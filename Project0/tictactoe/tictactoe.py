...
def player(board):
    ...
    #Count no of turns each player has had
    for row in board:
        for cell in row:
            if cell == X:
                x_count += 1
    ...
    #Retuns which players turn on basis of who has had more turns
    if x_count <= o_count:
        return X
    else:
        return O
...
def actions(board):
    ...
    #Checks all empty positions and returns them as actions
...
def result(board, action):
    ...
    #Makes a copy of the board, adds action to it
...
def winner(board):
    ...
    """
    #Define possible winning conditions
    wins = [[(0, 0), (0, 1), (0, 2)],
            [(1, 0), (1, 1), (1, 2)],
            [(2, 0), (2, 1), (2, 2)],
            [(0, 0), (1, 0), (2, 0)],
    ...
    #Check if current board is combination of any of the defined winning conditions, Return Winner
...
def minimax(board):
    ...
    # Optimization by hardcoding the first move for the Computer
